...
namespace B4
{
    public static class Config
    {
        ...
        public static string K9RepositoryDirectory = System.IO.Path.Combine("Projects", "K9");

        public static string PingHost = "github.com";

        public static string ProjectName = "NightOwl";

        public static string ProjectRelativePath = System.IO.Path.Combine("Projects", "NightOwl");
